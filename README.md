...
Many early efforts in adversarial fashion focused on older “person detection” systems such as the classic [**HAAR Cascade**](https://medium.com/analytics-vidhya/haar-cascades-explained-38210e57970d) models. Those designs worked well against simpler algorithms, but modern facial recognition has advanced far beyond them. I am not criticizing those projects; they were groundbreaking and provides a strong foundation to build on. This project, quite literally, stands on their shoulders; they are giants who paved the way. My work continues that evolution, bringing those early ideas into a new generation of adversarial textiles made for today’s much more advanced detection systems.
