...
All images used for training, baselining, and active fuzzing do not depict real people. Our testing relies exclusively on synthetic images generated by AI, including Google Nano Banana and [This Person Does Not Exist](https://thispersondoesnotexist.com/). At this time, we are not using any scraped, downloaded, or otherwise obtained `real human` images. Any likeness to a real human is purely coincidental. Should we move to testing with real human images in the future, we will secure full, explicit permission and consent from the individual featured. If you believe any of our testing images use your likeness and wish for them to be removed, please contact **bill@seckc.org**.
